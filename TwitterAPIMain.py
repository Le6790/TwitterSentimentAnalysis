...
class TwitterClient(object): 
    ...
    def get_tweet_sentiment(self, tweet): 
        ...
        if analysis.sentiment.polarity > 0: 
            ...
            print( str(tweet[0:50]) + " | Positive: " + str(analysis.sentiment.polarity))
            return 'positive'
        elif analysis.sentiment.polarity == 0: 
            print( str(tweet[0:50]) + "Neutral: " + str(analysis.sentiment.polarity))
            return 'neutral'
        else:
            print( str(tweet[0:50]) + "Negative: " + str(analysis.sentiment.polarity))
            return 'negative'
...
def main(): 
    ...
    tweets = api.get_tweets(query = '#DisneyPlus', count = 3) 
